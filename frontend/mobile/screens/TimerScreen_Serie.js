...
export default function TimerScreen({ route, navigation }) {
  ...
  // enregistre la série avec le VRAI temps de repos (le chrono) puis revient à l'exo (série suivante)
      ...
      <View className="flex-1 items-center justify-center px-6">
        ...
        {mode === 'chrono' ? (
          ...
          <>
            ...
            {/* commandes : Démarrer/Pause tant qu'il reste du temps, sinon Prochaine série + Reset */}
              ...
              {restant > 0 ? (
                ...
                <Pressable onPress={continuer}>
                  ...
                  >
                    ...
                    <Text className="font-bold text-base ml-2" style={{ color: couleur }}>Prochaine série</Text>
                  </LinearGradient>
                </Pressable>
              )}
